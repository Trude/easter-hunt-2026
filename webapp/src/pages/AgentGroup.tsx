    ...
    <div className="min-h-screen bg-yellow-50 px-4 py-6 max-w-lg mx-auto">
      ...
      {currentIdx === 0 && !showResult && (
        <div className="border border-gray-200 rounded p-3 mb-4">
          <p className="font-pixel text-gray-600 text-xs leading-relaxed italic">
            {group.intro}
          </p>
        </div>
      )}
          ...
          {currentQuestion.format === 'text' && (
            <div className="flex flex-col gap-2">
              <input
                ...
                className={`bg-white/80 border rounded px-3 py-3 font-pixel text-xs text-gray-800 placeholder-gray-400 outline-none focus:border-mc-yellow disabled:opacity-60 ${
                  showResult
